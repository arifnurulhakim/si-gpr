        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white shadow-lg transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
            ...
            <nav class="mt-8">
                <div class="px-4 space-y-2">
                    ...
                    <!-- Manajemen Warga Dropdown -->
                    <div class="relative">
                        <button id="data-penduduk-toggle" class="flex items-center justify-between w-full px-4 py-3 text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-700 transition-colors {{ request()->routeIs('families.*') || request()->routeIs('family-members.*') || request()->routeIs('resident-blocks.*') ? 'bg-indigo-50 text-indigo-700' : '' }}">
                    ...
                    <a href="{{ route('water-meter-photos.index') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-700 transition-colors {{ request()->routeIs('water-meter-photos.*') ? 'bg-indigo-50 text-indigo-700' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (dataPendudukToggle) {
                    ...
                    // Auto-open dropdown if on families, family-members, or resident-blocks route
                    if (window.location.pathname.includes('/families') || window.location.pathname.includes('/family-members') || window.location.pathname.includes('/resident-blocks')) {
                        dataPendudukMenu.classList.remove('hidden');
                        dataPendudukArrow.style.transform = 'rotate(180deg)';
                    }
                }
