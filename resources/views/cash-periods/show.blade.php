...
@section('title', 'Detail Periode Kas - E-Kartu Keluarga')
        ...
        <div class="lg:hidden">
            ...
            <div class="border-t border-gray-200 p-4">
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-gray-900">{{ $record->family->head_of_family_name }}</p>
                        <p class="text-sm text-gray-600">{{ $record->family->family_card_number }}</p>
                    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div>
                                <div class="text-sm font-medium text-gray-900">{{ $record->family->head_of_family_name }}</div>
                                <div class="text-sm text-gray-500">{{ $record->family->family_card_number }}</div>
                            </div>
                        </td>
