        ...
        <div class="lg:hidden">
            ...
            <div class="border-t border-gray-200 p-4">
                ...
                <div class="flex items-center justify-between pt-2">
                    ...
                    <button onclick="confirmRecordDelete('{{ $record->id }}', '{{ $record->residentBlock ? $record->residentBlock->block : "Record" }}')" class="text-red-600 hover:text-red-900 text-sm font-medium">Hapus</button>
                </div>
            </div>
            @empty
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                <button onclick="confirmRecordDelete('{{ $record->id }}', '{{ $record->residentBlock ? $record->residentBlock->block : "Record" }}')" class="text-red-600 hover:text-red-900" title="Hapus">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
