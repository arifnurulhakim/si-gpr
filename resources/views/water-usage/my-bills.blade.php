                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between pt-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('my-water-usage.print', [$record->waterPeriod->id, $record->id]) }}" target="_blank" class="text-green-600 hover:text-green-900 text-sm font-medium">Cetak Struk</a>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                @if($record->payment_status === 'LUNAS' && $record->verified_at)
                                <a href="{{ route('my-water-usage.print', [$record->waterPeriod->id, $record->id]) }}" target="_blank" class="text-green-600 hover:text-green-900" title="Cetak Struk">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
